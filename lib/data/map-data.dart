...
class MapData {
  ...
  MapData(this.title, this.description, this.mapPath) {
    ...
    id = Uuid().v4();
    data.add(MonsterData("brown-bear", new Vec2(9, 9), "https://angrygolem-games.com/wp-content/uploads/2021/11/Brown-Bear-1024x1024.jpg"));
    data.add(MonsterData("aboleth", new Vec2(10, 10), "https://cdn.shopify.com/s/files/1/1066/8352/files/Aboleth_480x480.jpg?v=1631029621"));
    data.add(MonsterData("deva", new Vec2(11, 11), MonsterData.noImgFound));
  }
